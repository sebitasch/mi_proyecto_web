...
import { BackdropParallax } from "@/components/motion/BackdropParallax";
  ...
  return (
    <html lang={locale}>
      ...
      <body className={`${inter.variable} ${spaceGrotesk.variable} flex min-h-screen flex-col`}>
        ...
        */}
        {/* Fondo global: la red de nodos se dibuja en servidor y
            BackdropParallax publica scroll y puntero para que se mueva. Fuera
            del provider a proposito: no traduce nada. */}
        <SiteBackdrop />
        <BackdropParallax />
